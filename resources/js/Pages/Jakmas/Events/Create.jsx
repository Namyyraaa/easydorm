...
export default function Create() {
  ...
  const submit = (e) => {
    e.preventDefault();
    post(route('jakmas.events.store'), { forceFormData: true });
  };

  return (
    <AuthenticatedLayout header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Create Event (JAKMAS)</h2>}>
      ...
      <form onSubmit={submit} className="space-y-3">
        ...
        <div className="flex gap-2">
          ...
          <Link href={route('jakmas.events.index')} className="px-3 py-2 bg-gray-200 rounded">Cancel</Link>
        </div>
      </form>
      </div>
    </AuthenticatedLayout>
