          ...
          <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
            <div className="border-b px-6 pt-4">
              <div className="flex gap-2">
                <button
                  type="button"
                  className={`px-3 py-2 rounded-t ${activeTab === 'single' ? 'bg-indigo-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
                ...
                <button
                  type="button"
                  className={`px-3 py-2 rounded-t ${activeTab === 'bulk' ? 'bg-indigo-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
