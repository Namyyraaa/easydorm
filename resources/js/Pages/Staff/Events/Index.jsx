    ...
    <AuthenticatedLayout header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Events</h2>}>
      <div className="p-6">
        <div className="flex justify-between items-center mb-4">
          ...
          <Link href={route('staff.events.create')} className="px-3 py-2 bg-blue-600 text-white rounded">Create Event</Link>
        </div>
              ...
              <div className="flex justify-between">
                ...
                <div>
                  {String(ev.created_by) === String(userId) ? (
                    <Link href={route('staff.events.show', ev.id)} className="text-blue-600">Manage</Link>
                  ) : (
